...
<div data-options="region:'center'" style="padding:5px;background:#eee;">
    <div class="easyui-panel" style="width:100%;height:100%;padding:10px;background:#fafafa;">
        <form method="post">
            ...
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="width:80px" onclick="downLoadTemplete2();">下载模板</a>
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="width:80px" onclick="showUpload2();">导入</a>
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="width:80px" onclick="exportExcel();">导出</a>
        </form>
