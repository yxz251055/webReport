...
<div id="excel_4_Form" class="panel window " style="display: none;width: 688px;left: 219px; top: 60px; z-index: 9002;"
    ...
    <div style="padding: 10px; width: 666px; height: 360px;" class="panel-body panel-body-noborder window-body">
        ...
        <div class="row1">
            ...
            <div class="col4">
                <span class="textbox easyui-fluid">
                    <input id="InvoiceAmountAdd" type="text" class="textbox-text">
                </span>
            </div>
        </div>
    </div>
    <div class="dialog-button" style="position: relative; top: -1px; width: 676px;">
        <a href="javascript:void(0)" class="l-btn l-btn-small" onclick="saveInvoiceIssuedInformation();">
