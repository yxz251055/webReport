...
<div id="excel_3_Form" class="panel window " style="display: none;width: 688px;left: 219px; top: 60px; z-index: 9002;"
    ...
    <div style="padding: 10px; width: 666px; height: 360px;" class="panel-body panel-body-noborder window-body">
        ...
        　　          <input id="contractIdAdd" type="text" class="easyui-datebox" required="required" >
                </span>
            </div>
            <div class="col3">
                <sapn>&nbsp;&nbsp;&nbsp;项目EAS代码：</sapn>
        ...
        <div class="row1">
            ...
            <div class="col2">
                <span style="float: right">
        　　          <input id="projectOutput" type="text" class="easyui-datebox" >
                </span>
            </div>
            <div class="col3">
                <sapn>&nbsp;&nbsp;&nbsp;合同约定回款节点比例：</sapn>
            </div>
            <div class="col4">
                <span class="textbox easyui-fluid">
                    <input id="backPaymentNodeProportion" type="text" class="textbox-text">
                </span>
            </div>
        </div>
        <div class="row1">
            ...
            <div class="col2">
                <span style="float: right">
        　　          <input id="contractNodeReceivables" type="text" class="easyui-datebox" >
                </span>
            </div>
            <div class="col3">
                <sapn>&nbsp;&nbsp;&nbsp;开具发票金额：</sapn>
            ...
            <div class="col4">
                <span class="textbox easyui-fluid">
                    <input id="InvoiceAmount" type="text" class="textbox-text">
                </span>
            </div>
        </div>
    </div>
    <div class="dialog-button" style="position: relative; top: -1px; width: 676px;">
        <a href="javascript:void(0)" class="l-btn l-btn-small" onclick="saveProjectCollection();">
